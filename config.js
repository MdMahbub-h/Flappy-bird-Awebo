...
const gameOptions = {
    ...
    birdSpeedCoef: { // horizontal bird speed coefficient depends on mode
        easy: 1.0,
        normal: 1.25,
        hard: 1.5,
        crazy: 1.7
    },
    moneyProb: { // probability of a coin appearing (0, 100) depends on mode
        easy: 20,
        normal: 30,
        hard: 40,
        crazy: 50 
...
const game_data = {
    ...
    'styles': { // different styles used for the text
        ...
        'easy_text': {fontSize: 30, color:'#fff', stroke: '#356e1e', strokeThickness: 5},
        'normal_text': {fontSize: 30, color:'#fff', stroke: '#6d6e1e', strokeThickness: 5},
        'hard_text': {fontSize: 30, color:'#fff', stroke: '#6e491e', strokeThickness: 5},
        'crazy_text': {fontSize: 30, color:'#fff', stroke: '#6e1e2f', strokeThickness: 5},
    ...
    'ads': { // configuration of ads
        'interstitial': {
            'event_mult': {
                'level_lost': 1, 'level_start': 0.3,
                'game_start': 0, 'change_scene': 0
            }
		},
        'rewarded': {}
	},
    ...
    'shop': { // shop config
        ...
        'money': [ // money positions
            {'id': 'harry', 'price': 100}, {'id': 'ron', 'price': 100},
            {'id': 'hermi', 'price': 200},{'id': 'draco', 'price': 300}
        ],
...
const local_user_data = {
    ...
    'global_score_mode': { // best score for every mode
        'easy': 0,
        'normal': 0,
        'hard': 0,
        'crazy': 0
    },
    'old_global_score_mode': { // previous best score for every mode
        'easy': 0,
        'normal': 0,
        'hard': 0,
        'crazy': 0
    ...
    'money_resourses': ['harry'], // skins got due to paying money
    // 'ad_resourses': ['harry', 'ron', 'hermi'],
    'ad_resourses': [], // skins got due to watching rewarded ad
    'current_resourse': 'harry' // current skin
}

if (loading_vars['codecanyon_live']) game_data['urls'] = {
    'audio': '../assets/audio/'
};